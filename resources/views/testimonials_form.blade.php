    ...
    <div class="content-wrapper">
      ...
      <div class="row justify-content-center">
        <div class="col-9 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h3 class="card-title" style="text-align:center">Testimonials Form</h3>
              <p class="card-description "> Insert Testimonials Details </p>

              <form class="forms-sample" method="post" action="{{route('testimonials.store')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row mt-3">
                  ...
                  <div class="col-sm-9">
                    <textarea rows="4" class="form-control" id="review" name="review" placeholder="Enter Review">{{old('review')}}</textarea>
                    <span class="text-danger">
                      @error('review')
                        {{$message}}
                      @enderror
